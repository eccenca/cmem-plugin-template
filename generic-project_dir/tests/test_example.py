...
from cmem_plugin_generic-project.example_transform import Lifetime
from cmem_plugin_generic-project.example_workflow import DollyPlugin
from tests.utils import TestExecutionContext, needs_cmem

PROJECT_NAME = "generic-project_test_project"
...
def di_environment() -> object:
    ...
    with io.StringIO("generic-project plugin sample file.") as response_file:
        create_resource(
            project_name=PROJECT_NAME,
